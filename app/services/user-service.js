    ...
    postUser: function (db, user, callback) {
        async.waterfall([
            ...
            sendmail({
                    ...
                    html: 'Beste ' + user.firstname + ", bedankt voor uw registratie. Klik op de volgende link om uw account te activeren: https://zvh-api.herokuapp.com/User/activate?token=" + token,
                }, function(err, reply) {
